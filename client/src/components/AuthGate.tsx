    ...
    <main className="min-h-screen bg-[#132A32] p-3 sm:p-6 lg:p-8">
      <section className="mx-auto grid min-h-[calc(100vh-1.5rem)] max-w-6xl overflow-hidden rounded-[1.75rem] bg-[#F6F4EE] shadow-2xl shadow-black/25 lg:grid-cols-[1.1fr_.9fr] dark:bg-[#17242A]">
        <div className="relative hidden overflow-hidden bg-[#102B35] p-10 text-white lg:flex lg:flex-col">
          <img src="/manus-storage/gestionpro-auth-studio_db5dba1b.png" alt="Composición editorial de agenda y flujo operativo" className="absolute inset-0 h-full w-full object-cover opacity-80" />
          <div className="absolute inset-0 bg-gradient-to-b from-[#0B2027]/55 via-[#0B2027]/35 to-[#0B2027]/80" />
          <div className="relative flex items-center gap-3"><img src="/manus-storage/gestionpro-mark_51952039.png" alt="GestionPro" className="h-11 w-11 rounded-xl bg-white/90 p-1.5" /><span className="text-xl font-extrabold tracking-tight">Gestion<span className="text-[#5DDBC0]">Pro</span></span></div>
        ...
        <div className="flex flex-col justify-center px-6 py-10 sm:px-12 lg:px-14">
          <div className="mb-10 flex items-center justify-between lg:hidden"><div className="flex items-center gap-2"><img src="/manus-storage/gestionpro-mark_51952039.png" alt="GestionPro" className="h-10 w-10 rounded-xl" /><span className="text-lg font-extrabold">GestionPro</span></div><span className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Acceso seguro</span></div>
