...
export default function GlobalSearch({ open, onClose, onNavigate, customers, reservations, payments, tasks, incidents, expenses, isAdmin, index = [] }: { open: boolean; onClose: () => void; onNavigate: (destination: GlobalSearchDestination) => void; customers: Customer[]; reservations: Reservation[]; payments: Payment[]; tasks: Task[]; incidents: Incident[]; expenses: Expense[]; isAdmin: boolean; index?: GlobalSearchIndexEntry[] }) {
